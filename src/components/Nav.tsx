      ...
      >
        ...
        <div className="relative flex items-center gap-2 sm:gap-4">
          ...
          <a
            ...
            className="whitespace-nowrap bg-white px-3 py-2 text-[10px] font-medium uppercase tracking-[0.1em] text-[#1C1C1C] transition-colors duration-300 hover:bg-white/90 active:scale-95 sm:px-6 sm:py-3 sm:text-[12px] sm:tracking-[0.15em]"
          >
            ĐẶT LỊCH
          </a>
        </div>
